...
| Phase 5d quality (.NET test projects) | `src/Test/Test.Unit`, `src/Test/Test.Integration`, `src/Test/Test.Endpoints`, `src/Test/Test.E2E`, `src/Test/Test.Architecture`, `src/Test/Test.Load`, `src/Test/Test.Benchmarks`, `src/Test/Test.Mutation`, `src/Test/Test.Support` | `dotnet test`-runnable test project layout, Stryker.NET mutation samples, and quality-gate coverage. |
