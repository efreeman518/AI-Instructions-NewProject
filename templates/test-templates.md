...
| 5d | [test-templates-quality.md](test-templates-quality.md) | `Test/Test.Architecture/**`, `Test/Test.Load/**`, `Test/Test.Benchmarks/**`, `Test/Test.PlaywrightUI/**` (hosted-stack; C# MSTest or Node Playwright for React/Vite), `Test/Test.E2E/**` |
