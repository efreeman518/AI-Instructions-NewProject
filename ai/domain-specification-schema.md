...
> **Note:** Authentication is configured in the final phase (Phase 5f). During earlier phases, auth is stubbed. See [skills/identity-management.md](../skills/identity-management.md).
